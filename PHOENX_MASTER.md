...
## Version 4.0 — Document unique et définitif
### Remplace intégralement tous les documents précédents
...
Son fondateur a fait trois arrêts cardiaques. Trois fois, le cœur s'est arrêté. Trois fois, il est revenu. Et à chaque retour, la même pensée :

*"Si je n'étais pas revenu, qu'est-ce que j'aurais laissé ?"*

Pas des documents administratifs. Pas un mot de passe noté quelque part. Rien de ce qui compte vraiment — les valeurs, les regrets, les amours, les histoires qu'on n'a jamais eu le temps de raconter. L'histoire de la mère d'Audrey. L'histoire de Fab. On a laissé rien pour ceux qui restent.

C'est de cette expérience que naît PHOEN-X. Pas une idée de startup imaginée dans un incubateur — une réponse viscérale à une question que la mort a posée en vrai, trois fois.
...
## Ce qu'est PHOEN-X en une phrase
...
- Ce n'est pas un clone conversationnel du défunt.
- Ce n'est pas une archive froide et administrative.

## L'avantage compétitif fondateur

Le concurrent le plus proche en France — In-Memory — est né d'une observation intellectuelle. PHOEN-X est né d'une expérience corporelle, réelle, trois fois répétée. La différence entre quelqu'un qui a *pensé* à la mort et quelqu'un qui l'a *rencontrée* se ressent dans chaque décision produit. C'est impossible à copier.
...
## 4.2 — LE FIL DE PENSÉE PAR ÂGE ⭐ Fonctionnalité signature absolue

### Ce que c'est

Une chronologie de pensées liée à l'**âge exact** du Créateur au moment du dépôt. Pas seulement la date — l'âge. "Ce que je pensais à 40 ans. À 43 ans. À 47 ans."
...
| Poésie | — |
| Coups de gueule | Assouvi / Non assouvi |
| Angoisses | Assouvie / Non assouvie |
| Bonheur | — |
| Plaisir | — |
| Regret | Assouvi / Non assouvi |
| Sagesse | — |
| Amour | — |
| Valeurs | — |
...
Au lieu de "comment confirme-t-on que je suis mort", le système demande "comment je prouve chaque semaine que je suis vivant". Un seul tap discret, une fois par semaine. Si trois semaines passent sans tap → le Dépositaire reçoit une alerte.
...
Non seulement ce qu'on laisse de soi, mais ce qu'on laisse de ceux qu'on a aimés, vu de ses propres yeux. Une grand-mère qui laisse le portrait de son petit-fils tel qu'elle le voit. Un père qui laisse à sa fille la description de la femme qu'il a vue grandir.
...
|---|---|
| Application mobile | Android Studio + Kotlin + Jetpack Compose |
...
| Intelligence artificielle | Vertex AI / Gemini |
...
users/{userId}/entries/{entryId}/amendments/{amendmentId}
  encryptedContent: Bytes
  ageAtAmendment: Map              {years, months, days, displayLabel}
  createdAt: Timestamp
...
users/{userId}/depositaries/{depositaryId}
  name: String
  email: String
  phone: String
...
AccentPrimary = 0xFFC97B3A
AccentSecondary = 0xFFE8A85F
TextPrimary = 0xFFF2EDE8
TextSecondary = 0xFF9B9590
TextTertiary = 0xFF5C5855
Success = 0xFF4CAF50
Error = 0xFFE57373
Warning = 0xFFFFB74D
...
## PROMPT 4 — Modèles de données Kotlin
...
## PROMPT 13 — Protocole d'activation, Preuve de Vie, Accessibilité
...
## TABLEAU DE BORD — Ordre d'exécution des prompts
...
3. Ne jamais envoyer du contenu chiffré à Vertex AI — uniquement les aiSummary et aiTags
